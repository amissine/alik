...
set shortmess=aoO
badd +122 feed/feed.go
badd +1 util/common.sh
badd +0 util/curl.sh
argglobal
silent! argdel *
$argadd feed/feed.go
...
wincmd w
argglobal
if bufexists('~/go/src/github.com/amissine/alik/util/curl.sh') | buffer ~/go/src/github.com/amissine/alik/util/curl.sh | else | edit ~/go/src/github.com/amissine/alik/util/curl.sh | endif
setlocal keymap=
setlocal noarabic
setlocal noautoindent
setlocal backupcopy=
...
29
normal! zo
let s:l = 39 - ((10 * winheight(0) + 7) / 15)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
39
...
107
normal! zo
let s:l = 122 - ((13 * winheight(0) + 7) / 14)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
122
