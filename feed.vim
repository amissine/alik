...
set expandtab
set helplang=en
set runtimepath=~/.vim,~/.vim/pack/plugins/start/vim-go,/usr/local/share/vim/vimfiles,/usr/local/share/vim/vim81,/usr/local/share/vim/vimfiles/after,~/.vim/after
set shiftwidth=2
set tabstop=2
...
wincmd w
argglobal
if bufexists("~/go/src/github.com/amissine/alik/util/common.sh") | buffer ~/go/src/github.com/amissine/alik/util/common.sh | else | edit ~/go/src/github.com/amissine/alik/util/common.sh | endif
setlocal keymap=
setlocal noarabic
setlocal noautoindent
setlocal backupcopy=
...
30
normal! zo
let s:l = 30 - ((29 * winheight(0) + 7) / 15)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
30
...
exe '3resize ' . ((&lines * 15 + 24) / 48)
tabnext
edit ~/go/src/github.com/amissine/alik/util/XRP.sh
set splitbelow splitright
wincmd _ | wincmd |
split
wincmd _ | wincmd |
...
wincmd w
argglobal
if bufexists("~/go/src/github.com/amissine/alik/util/USD.sh") | buffer ~/go/src/github.com/amissine/alik/util/USD.sh | else | edit ~/go/src/github.com/amissine/alik/util/USD.sh | endif
setlocal keymap=
setlocal noarabic
setlocal noautoindent
setlocal backupcopy=
...
wincmd w
argglobal
if bufexists("~/go/src/github.com/amissine/alik/util/SLT.sh") | buffer ~/go/src/github.com/amissine/alik/util/SLT.sh | else | edit ~/go/src/github.com/amissine/alik/util/SLT.sh | endif
setlocal keymap=
setlocal noarabic
setlocal noautoindent
setlocal backupcopy=
...
wincmd w
argglobal
if bufexists("~/go/src/github.com/amissine/alik/util/ETH.sh") | buffer ~/go/src/github.com/amissine/alik/util/ETH.sh | else | edit ~/go/src/github.com/amissine/alik/util/ETH.sh | endif
setlocal keymap=
setlocal noarabic
setlocal noautoindent
setlocal backupcopy=
...
wincmd w
argglobal
if bufexists("~/go/src/github.com/amissine/alik/util/CNY.sh") | buffer ~/go/src/github.com/amissine/alik/util/CNY.sh | else | edit ~/go/src/github.com/amissine/alik/util/CNY.sh | endif
setlocal keymap=
setlocal noarabic
setlocal noautoindent
setlocal backupcopy=
...
wincmd w
argglobal
if bufexists("~/go/src/github.com/amissine/alik/util/BTC.sh") | buffer ~/go/src/github.com/amissine/alik/util/BTC.sh | else | edit ~/go/src/github.com/amissine/alik/util/BTC.sh | endif
setlocal keymap=
setlocal noarabic
setlocal noautoindent
setlocal backupcopy=
...
setlocal wrap
setlocal wrapmargin=0
let s:l = 188 - ((187 * winheight(0) + 23) / 46)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
188
...
badd +1 ~/go/src/github.com/amissine/alik/util/XRP.sh
...
badd +1 ~/go/src/github.com/amissine/alik/util/ETH.sh
badd +1 ~/go/src/github.com/amissine/alik/util/CNY.sh
badd +3 ~/go/src/github.com/amissine/alik/util/BTC.sh
badd +7 ~/go/src/github.com/amissine/alik/mf.sh
...
badd +1 ~/go/src/github.com/amissine/alik/util/test_curl.sh
badd +6 ~/go/src/github.com/amissine/alik/tmp.sh
badd +59 /usr/local/go/src/os/proc.go
badd +312 /usr/local/go/src/log/log.go
