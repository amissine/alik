...
58
normal! zo
let s:l = 57 - ((56 * winheight(0) + 23) / 46)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
57
...
127
normal! zo
let s:l = 127 - ((0 * winheight(0) + 6) / 13)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
127
...
wincmd w
argglobal
if bufexists("~/go/src/github.com/amissine/alik/json/umf.go") | buffer ~/go/src/github.com/amissine/alik/json/umf.go | else | edit ~/go/src/github.com/amissine/alik/json/umf.go | endif
nnoremap <buffer> <silent>  :call go#def#StackPop(v:count1)
nnoremap <buffer> <silent> ] :call go#def#Jump("split", 0)
nnoremap <buffer> <silent>  :call go#def#Jump("split", 0)
nnoremap <buffer> <silent>  :GoDef
...
94
normal! zo
let s:l = 124 - ((41 * winheight(0) + 15) / 31)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
124
...
tabnext 4
set stal=1
badd +54 ~/go/src/github.com/amissine/alik/Makefile
badd +15 ~/go/src/github.com/amissine/alik/service/feed.sh
badd +15 ~/go/src/github.com/amissine/alik/feed/feed.go
