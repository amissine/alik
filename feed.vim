...
wincmd w
argglobal
if bufexists("~/go/src/github.com/amissine/alik/tbot.sh") | buffer ~/go/src/github.com/amissine/alik/tbot.sh | else | edit ~/go/src/github.com/amissine/alik/tbot.sh | endif
setlocal keymap=
setlocal noarabic
setlocal noautoindent
setlocal backupcopy=
...
61
normal! zo
let s:l = 76 - ((75 * winheight(0) + 23) / 46)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
76
...
badd +0 ~/go/src/github.com/amissine/alik/util.sh
