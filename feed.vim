...
50
normal! zo
let s:l = 44 - ((43 * winheight(0) + 23) / 46)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
44
...
78
normal! zo
let s:l = 78 - ((75 * winheight(0) + 23) / 46)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
78
...
badd +0 ~/go/src/github.com/amissine/alik/feed/feed.go
badd +0 ~/go/src/github.com/amissine/alik/gobble/main.go
