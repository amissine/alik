...
54
normal! zo
let s:l = 10 - ((0 * winheight(0) + 16) / 32)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
10
...
exe '2resize ' . ((&lines * 32 + 24) / 48)
tabnext
edit ~/go/src/github.com/amissine/alik/util/common.sh
set splitbelow splitright
wincmd _ | wincmd |
split
1wincmd k
...
17
normal! zo
let s:l = 26 - ((23 * winheight(0) + 23) / 46)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
26
...
122
normal! zo
let s:l = 124 - ((80 * winheight(0) + 23) / 46)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
124
