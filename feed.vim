...
set helplang=en
set runtimepath=~/.vim,~/.vim/pack/plugins/start/vim-go-1.20,/usr/local/share/vim/vimfiles,/usr/local/share/vim/vim81,/usr/local/share/vim/vimfiles/after,~/.vim/after
set shiftwidth=2
set tabstop=2
...
badd +6 service/feed_log_run.sh
badd +0 util/common.sh
badd +1 util/XRP.sh
badd +1 util/USD.sh
badd +1 util/CNY.sh
badd +0 util/BTC.sh
badd +0 service/feed2.sh
argglobal
silent! argdel *
$argadd Makefile
set stal=2
edit service/update.sh
...
exe '1resize ' . ((&lines * 12 + 24) / 48)
exe '2resize ' . ((&lines * 32 + 24) / 48)
tabedit ~/go/src/github.com/amissine/alik/util/BTC.sh
set splitbelow splitright
wincmd _ | wincmd |
split
wincmd _ | wincmd |
...
wincmd w
argglobal
if bufexists('~/go/src/github.com/amissine/alik/util/XRP.sh') | buffer ~/go/src/github.com/amissine/alik/util/XRP.sh | else | edit ~/go/src/github.com/amissine/alik/util/XRP.sh | endif
setlocal keymap=
setlocal noarabic
setlocal noautoindent
setlocal backupcopy=
...
exe '4resize ' . ((&lines * 1 + 24) / 48)
exe '5resize ' . ((&lines * 37 + 24) / 48)
tabedit ~/go/src/github.com/amissine/alik/util/common.sh
set splitbelow splitright
wincmd _ | wincmd |
split
wincmd _ | wincmd |
