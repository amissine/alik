...
54
normal! zo
let s:l = 10 - ((4 * winheight(0) + 14) / 29)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
10
...
58
normal! zo
let s:l = 49 - ((48 * winheight(0) + 19) / 38)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
49
...
103
normal! zo
let s:l = 114 - ((70 * winheight(0) + 23) / 46)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
114
...
badd +12 ~/go/src/github.com/amissine/alik/service/feed_run.sh
