...
wincmd w
argglobal
if bufexists("~/go/src/github.com/amissine/alik/feed/feed.go") | buffer ~/go/src/github.com/amissine/alik/feed/feed.go | else | edit ~/go/src/github.com/amissine/alik/feed/feed.go | endif
nnoremap <buffer> <silent>  :call go#def#StackPop(v:count1)
nnoremap <buffer> <silent> ] :call go#def#Jump("split", 0)
nnoremap <buffer> <silent>  :call go#def#Jump("split", 0)
nnoremap <buffer> <silent>  :GoDef
...
tabnext 1
set stal=1
badd +26 ~/go/src/github.com/amissine/alik/service/feed.sh
...
badd +17 ~/go/src/github.com/amissine/alik/feed/feed.go
badd +1 ~/go/src/github.com/amissine/alik/service/gobble.sh
badd +567 /usr/local/go/src/bufio/bufio.go
badd +8 ~/.profile
badd +1 ~/go/src/github.com/amissine/alik/util/common.sh
badd +1 ~/.vim/pack/plugins/start/vim-go/README.md
