...
54
normal! zo
let s:l = 50 - ((49 * winheight(0) + 23) / 46)
...
64
normal! zo
let s:l = 64 - ((63 * winheight(0) + 23) / 46)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
64
...
50
normal! zo
let s:l = 88 - ((85 * winheight(0) + 23) / 46)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
88
